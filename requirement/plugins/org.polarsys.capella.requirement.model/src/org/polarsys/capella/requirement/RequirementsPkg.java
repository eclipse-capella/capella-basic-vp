 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.capella.requirement.RequirementsPkg#getAdditionalInformation <em>Additional Information</em>}</li>
 *   <li>{@link org.polarsys.capella.requirement.RequirementsPkg#getLevel <em>Level</em>}</li>
 *   <li>{@link org.polarsys.capella.requirement.RequirementsPkg#getOwnedRequirements <em>Owned Requirements</em>}</li>
 *   <li>{@link org.polarsys.capella.requirement.RequirementsPkg#getOwnedRequirementPkgs <em>Owned Requirement Pkgs</em>}</li>
 * </ul>
 *
 * @see org.polarsys.capella.requirement.RequirementPackage#getRequirementsPkg()
...
public interface RequirementsPkg extends Structure, ElementExtension {
	 ...
	 * @see org.polarsys.capella.requirement.RequirementPackage#getRequirementsPkg_AdditionalInformation()
	...
	/**
	 * Sets the value of the '{@link org.polarsys.capella.requirement.RequirementsPkg#getAdditionalInformation <em>Additional Information</em>}' attribute.
	 ...
	 * @see #setLevel(String)
	 * @see org.polarsys.capella.requirement.RequirementPackage#getRequirementsPkg_Level()
	...
	/**
	 * Sets the value of the '{@link org.polarsys.capella.requirement.RequirementsPkg#getLevel <em>Level</em>}' attribute.
	 ...
	 * The list contents are of type {@link org.polarsys.capella.requirement.Requirement}.

	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Owned Requirements</em>' containment reference list.
	 * @see org.polarsys.capella.requirement.RequirementPackage#getRequirementsPkg_OwnedRequirements()
	 ...
	 * The list contents are of type {@link org.polarsys.capella.requirement.RequirementsPkg}.

	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Owned Requirement Pkgs</em>' containment reference list.
	 * @see org.polarsys.capella.requirement.RequirementPackage#getRequirementsPkg_OwnedRequirementPkgs()
	 * @model containment="true"
	 *        annotation="http://www.polarsys.org/capella/2007/UML2Mapping featureName='packagedElement' featureOwner='Package'"
