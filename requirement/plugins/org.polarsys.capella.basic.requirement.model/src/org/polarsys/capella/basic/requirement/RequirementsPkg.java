 ...
 * </p>
 * <ul>
 *   <li>{@link org.polarsys.capella.basic.requirement.RequirementsPkg#getAdditionalInformation <em>Additional Information</em>}</li>
 *   <li>{@link org.polarsys.capella.basic.requirement.RequirementsPkg#getLevel <em>Level</em>}</li>
 *   <li>{@link org.polarsys.capella.basic.requirement.RequirementsPkg#getOwnedRequirements <em>Owned Requirements</em>}</li>
 *   <li>{@link org.polarsys.capella.basic.requirement.RequirementsPkg#getOwnedRequirementPkgs <em>Owned Requirement Pkgs</em>}</li>
 * </ul>
 *
 * @see org.polarsys.capella.basic.requirement.RequirementPackage#getRequirementsPkg()
...
public interface RequirementsPkg extends Structure, ElementExtension {
	 ...
	 * @see org.polarsys.capella.basic.requirement.RequirementPackage#getRequirementsPkg_AdditionalInformation()
	 ...
	 * @see #setLevel(String)
	 * @see org.polarsys.capella.basic.requirement.RequirementPackage#getRequirementsPkg_Level()
	 ...
	 * @see org.polarsys.capella.basic.requirement.RequirementPackage#getRequirementsPkg_OwnedRequirements()
	 ...
	 * @see org.polarsys.capella.basic.requirement.RequirementPackage#getRequirementsPkg_OwnedRequirementPkgs()
	 * @model containment="true"
	 *        annotation="http://www.polarsys.org/capella/2007/UML2Mapping featureName='packagedElement' featureOwner='Package'"
