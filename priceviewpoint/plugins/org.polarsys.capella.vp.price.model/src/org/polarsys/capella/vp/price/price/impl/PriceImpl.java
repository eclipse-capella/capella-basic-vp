...
public class PriceImpl extends NamedElementImpl implements Price {
  ...
  public void setMaxValue(int newMaxValue) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PricePackage.PRICE__MAX_VALUE, oldMaxValue, maxValue));
  ...
  public void setMinValue(int newMinValue) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PricePackage.PRICE__MIN_VALUE, oldMinValue, minValue));
