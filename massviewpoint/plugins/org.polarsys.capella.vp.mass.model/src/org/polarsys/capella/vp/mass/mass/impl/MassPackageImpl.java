...
public class MassPackageImpl extends EPackageImpl implements MassPackage {
  ...
  public void initializePackageContents() {
    ...
    initEClass(partMassEClass, PartMass.class, "PartMass", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
  ...
  protected void createConstraintAnnotations() {
    ...
    addAnnotation(partMassEClass, source,
        new String[] { "ExtendedElement", " http://www.polarsys.org/capella/core/cs/7.0.0#//Part" //$NON-NLS-1$ //$NON-NLS-2$
        });
  }
