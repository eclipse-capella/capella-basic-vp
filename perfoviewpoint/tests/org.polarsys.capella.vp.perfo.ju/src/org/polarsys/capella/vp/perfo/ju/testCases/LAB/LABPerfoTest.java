 ...
 */
public abstract class LABPerfoTest extends BasicTestCase {
	...
	/**
	 * Retrieves the AbstractFunction root of the Logical Architecture part of a
	 * capella model
	 * 
	...
	/**
	 * Change the value of the PerformanceCriteria of a LogicalFunction
	 * @param element the element we wish to change the performance
	 * @param newPerfo the new value of the performance
	 */
	protected void editPerfoLogicalFunction(LogicalFunction element, int newPerfo) {
