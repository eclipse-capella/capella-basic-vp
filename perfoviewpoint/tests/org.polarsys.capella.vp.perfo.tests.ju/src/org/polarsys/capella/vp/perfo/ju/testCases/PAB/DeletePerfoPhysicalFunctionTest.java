...
/**
 * This test case checks if when deleting a perfo from a PhysicalFunction
 ...
 */
public class DeletePerfoPhysicalFunctionTest extends PABPerfoTest {
	...
	public void test() throws Exception {
		...
		EObject perfoObject = physicalFunction3.getOwnedExtensions().get(0);
		...
		assertEquals("The performance of FC1 was not changed after the deletion of the performance of PF3",
