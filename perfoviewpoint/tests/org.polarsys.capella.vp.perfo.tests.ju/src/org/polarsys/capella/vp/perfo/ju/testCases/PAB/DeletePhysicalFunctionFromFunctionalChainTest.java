...
/**
 * This test case checks if when deleting a PhysicalFunction from a
 ...
 */
public class DeletePhysicalFunctionFromFunctionalChainTest extends PABPerfoTest {

	@Override
	public void test() throws Exception {
		FunctionalChain functionalChain1 = rootAbstractFunction.getOwnedFunctionalChains().get(0);
		FunctionalChainInvolvement functionalChainInvolvement = functionalChain1.getInvolvedFunctionalChainInvolvements().get(3);
		...
		assertEquals("The performance of FC1 was not changed after the deletion of PF3 from the functional chain",
