...
public class PerformanceCriteriaImpl extends NamedElementImpl implements PerformanceCriteria {
  ...
  public void setValue(int newValue) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PerfoPackage.PERFORMANCE_CRITERIA__VALUE, oldValue, value));
  ...
  public void setMaxValue(int newMaxValue) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PerfoPackage.PERFORMANCE_CRITERIA__MAX_VALUE, oldMaxValue,
          maxValue));
  ...
  public void setMinValue(int newMinValue) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PerfoPackage.PERFORMANCE_CRITERIA__MIN_VALUE, oldMinValue,
          minValue));
