...
public class PerfoPackageImpl extends EPackageImpl implements PerfoPackage {
  ...
  public void initializePackageContents() {
    ...
    initEClass(performanceCriteriaEClass, PerformanceCriteria.class, "PerformanceCriteria", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getPerformanceCriteria_Value(), ecorePackage.getEInt(), "value", null, 0, 1, //$NON-NLS-1$
        PerformanceCriteria.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
    ...
    initEClass(performanceCapacityEClass, PerformanceCapacity.class, "PerformanceCapacity", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
        IS_GENERATED_INSTANCE_CLASS);
    ...
    initEClass(timeCapacityEClass, TimeCapacity.class, "TimeCapacity", !IS_ABSTRACT, !IS_INTERFACE, //$NON-NLS-1$
        IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getTimeCapacity_CurrentExecutionTime(), ecorePackage.getEInt(), "currentExecutionTime", null, 0, 1, //$NON-NLS-1$
        TimeCapacity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
    ...
    initEAttribute(getUnityElement_MeasurementUnit(), this.getmeasurementUnit_Type(), "measurementUnit", null, 0, 1, //$NON-NLS-1$
        UnityElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
        IS_ORDERED);
  ...
  protected void createConstraintAnnotations() {
    ...
    addAnnotation(timeConsumptionEClass, source, new String[] { "ExtendedElement", //$NON-NLS-1$
        " http://www.polarsys.org/capella/core/fa/7.0.0#//FunctionalExchange http://www.polarsys.org/capella/core/pa/7.0.0#//PhysicalFunction http://www.polarsys.org/capella/core/la/7.0.0#//LogicalFunction" //$NON-NLS-1$
    });
    addAnnotation(timeCapacityEClass, source,
        new String[] { "ExtendedElement", " http://www.polarsys.org/capella/core/fa/7.0.0#//FunctionalChain" //$NON-NLS-1$ //$NON-NLS-2$
        });
  }
